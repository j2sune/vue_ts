...
import lazyLoad from '../components/scriptCont/lazyLoad.vue' /* 여기까지 */
...
export { popCont, slide, tab, arrcodion, tooltip, search, sortTable, scrollTab, lazyLoad, dropDown, bookmark, sortInputTable, toast, layerPop, category }
